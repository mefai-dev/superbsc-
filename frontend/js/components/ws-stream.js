// MEFAI WebSocket Stream 路路路 Real-time Binance price updates
...
class BinanceStream {
  constructor() {
    this._ws = null;
    this._subs = new Map();     // stream 路啋 Set of callbacks
    this._prices = new Map();   // symbol 路啋 {price, change, volume, high, low}
    this._reconnectTimer = null;
    this._connected = false;
    this._reconnectDelay = 1000; // exponential backoff: 1s 路啋 2s 路啋 4s 路啋 8s 路啋 max 30s
  }
