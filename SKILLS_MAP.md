...
Uses `/fapi/v1/constituents` 路路路 8 exchange composite weights for price comparison.
...
5 metrics 路啋 single health score (0-100): spread, spot futures gap, funding, taker balance, OI stability.
...
- `/futures/data/globalLongShortAccountRatio` 路路路 Retail positioning. **BINANCE ONLY**
- `/futures/data/topLongShortAccountRatio` 路路路 Top account positioning. **BINANCE ONLY**
- `/futures/data/topLongShortPositionRatio` 路路路 Smart money positioning. **BINANCE ONLY**
- `/futures/data/takerlongshortRatio` 路路路 Taker flow. **BINANCE ONLY**
...
Pipeline: Skill 2 路啋 Skill 6 路啋 Skill 5.3 路啋 Skill 4 路啋 Skill 7.3 路啋 Composite Score
